...
graph TD
    ...
    subgraph "<b>Phase 2: Learn</b> (Gradient Computation & Reduction)"
        ...
        subgraph "<b>Phase 2B:</b> Gradient Processing & Permutation"
            ...
            K12["(12) transpose_chunk<br/>[General Utility]"]:::unused_utility_kernel;
        end
...
- **(12) `transpose_chunk`**: A streamable utility kernel for transposing a contiguous 2D matrix slice.
  - **Phase Compatibility Note:** For now an unused general-purpose tool, not on the primary backpropagation path for `Grad_H`.
