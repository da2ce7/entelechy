...
class BackpropSharedWeightsChunkSignature(KernelSignature):
    ...
    h_ref: BufferHandle  # Post-activation hidden state
    grad_h_ref: BufferHandle  # Summed upstream gradient for hidden layer
    ...
    def get_args(self) -> List:
        """Returns all 12 arguments in exact contractual order."""
