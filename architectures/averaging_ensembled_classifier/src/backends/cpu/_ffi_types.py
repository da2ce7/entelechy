...
from ...shared.precision_suffix import (
    FP8_FP16_PRECISION_SUFFIXES as _SHARED_FP8_FP16_SUFFIXES,
    PRECISION_SUFFIXES,
)
...
def _detect_fp8_fp16_suffixes() -> tuple[str, ...]:
    try:
        ...
        if _HAS_FLOAT16:
            return _SHARED_FP8_FP16_SUFFIXES
    except ImportError:
        pass
    return ()
FP8_FP16_PRECISION_SUFFIXES: tuple[str, ...] = _detect_fp8_fp16_suffixes()
...
PRECISION_C_TYPES: dict[str, tuple[type, type, type, type, type, type]] = {
    ...
    "s8e4c16x16": (ctypes.c_uint8, c_uint8_p, c_uint16, POINTER(c_uint16), c_uint16, POINTER(c_uint16)),
    ...
    "s8e5c16x16": (ctypes.c_uint8, c_uint8_p, c_uint16, POINTER(c_uint16), c_uint16, POINTER(c_uint16)),
    # FP8 FP16 state variants with FP32/FP64 compute (conditional on _Float16)
    "s8e4c32x16": (ctypes.c_uint8, c_uint8_p, c_float, POINTER(c_float), c_uint16, POINTER(c_uint16)),
    "s8e4c64x16": (ctypes.c_uint8, c_uint8_p, c_double, POINTER(c_double), c_uint16, POINTER(c_uint16)),
    "s8e5c32x16": (ctypes.c_uint8, c_uint8_p, c_float, POINTER(c_float), c_uint16, POINTER(c_uint16)),
    "s8e5c64x16": (ctypes.c_uint8, c_uint8_p, c_double, POINTER(c_double), c_uint16, POINTER(c_uint16)),
}
...
def make_precision_types(
    ...
    """
    _c_storage, c_storage_p, c_compute, c_compute_p, _c_state, c_state_p = PRECISION_C_TYPES[suffix]

    def _s(name: str, fields: list[tuple[str, type]]) -> type:
    ...
    structs["ClipPartialsArgs"] = _s("ClipPartialsArgs", [
        ...
        ("partial_grad_temps", c_storage_p),
        ("partial_grad_hidden_activations_aos", c_storage_p),
        ("clipping_threshold_per_item", c_compute_p),
