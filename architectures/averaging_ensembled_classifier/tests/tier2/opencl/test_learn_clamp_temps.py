# tests/tier2/opencl/test_learn_clamp_temps.py
"""Tier 2 tests: clamp_temperatures kernel (Node 25)."""
...
class TestClampTemperatures:
    """Per-kernel correctness tests for clamp_temperatures."""
