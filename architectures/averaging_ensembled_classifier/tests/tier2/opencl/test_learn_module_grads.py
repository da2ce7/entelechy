# tests/tier2/opencl/test_learn_module_grads.py
"""Tier 2 tests: calculate_module_param_grads kernel (Node 8)."""
...
from tests.tier2.fixtures.numpy_forward import ref_compute_probs_loss_cce, ref_compute_probs_loss_bce
...
class TestModuleGrads:
    """Per-kernel correctness tests for module parameter gradients."""
    ...
    def test_module_grads_cce_basic(self):
        ...
        _tol = get_tolerance("calculate_module_param_grads_cce", "fp32")
    ...
    def test_module_grads_gradient_magnitude(self):
        ...
        # Larger batch should produce larger unnormalized gradient
