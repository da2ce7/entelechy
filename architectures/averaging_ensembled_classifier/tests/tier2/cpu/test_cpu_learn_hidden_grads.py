# tests/tier2/cpu/test_cpu_learn_hidden_grads.py
"""Tier 2 CPU tests: backprop_error_to_hidden kernel (Node 9)."""
...
class TestCpuHiddenGrads:
    """Per-kernel correctness tests for CPU backprop_error_to_hidden."""
