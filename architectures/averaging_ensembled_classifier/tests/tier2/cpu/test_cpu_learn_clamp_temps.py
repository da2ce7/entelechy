# tests/tier2/cpu/test_cpu_learn_clamp_temps.py
"""Tier 2 CPU tests: clamp_temperatures kernel (Node 25)."""
...
class TestCpuClampTemperatures:
    """Per-kernel correctness tests for CPU clamp_temperatures."""
