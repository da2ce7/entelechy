# tests/tier2/cpu/test_cpu_learn_temp_grads.py
"""Tier 2 CPU tests: calculate_chunk_temp_gradients kernel (Node 10)."""
...
class TestCpuTempGrads:
    """Per-kernel correctness tests for CPU temperature gradients."""
