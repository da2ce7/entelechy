# tests/tier2/cpu/test_cpu_learn_streaming_backprop.py
"""Tier 2 CPU tests: streaming loop backprop (Nodes 17-19)."""
...
class TestCpuStreamingBackprop:
    """Per-kernel correctness tests for CPU streaming loop backprop."""
