# tests/tier2/cpu/test_cpu_learn_gather_permute.py
"""Tier 2 CPU tests: gather_and_permute_grad_h kernel (Node 13)."""
...
class TestCpuGatherPermute:
    """Per-kernel correctness tests for CPU gather_and_permute_grad_h."""
