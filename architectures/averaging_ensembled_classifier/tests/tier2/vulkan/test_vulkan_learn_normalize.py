# tests/tier2/vulkan/test_vulkan_learn_normalize.py
"""Tier 2 Vulkan tests: normalize_gradients kernel (Node 21)."""
...
class TestVulkanNormalizeGradients:
    """Per-kernel correctness tests for Vulkan normalize_gradients."""
