# tests/tier2/vulkan/test_vulkan_learn_module_grads.py
"""Tier 2 Vulkan tests: calculate_module_param_grads kernel (Node 8)."""
...
class TestVulkanModuleGrads:
    """Per-kernel correctness tests for Vulkan module parameter gradients."""
