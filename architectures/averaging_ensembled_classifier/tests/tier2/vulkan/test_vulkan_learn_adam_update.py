# tests/tier2/vulkan/test_vulkan_learn_adam_update.py
"""Tier 2 Vulkan tests: adam_update kernel (Node 24)."""
...
class TestVulkanAdamUpdate:
    """Per-kernel correctness tests for Vulkan adam_update."""
