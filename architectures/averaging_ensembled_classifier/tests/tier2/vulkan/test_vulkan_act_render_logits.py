# tests/tier2/vulkan/test_vulkan_act_render_logits.py
"""Tier 2 Vulkan tests: render_logits kernel (Node 5)."""
...
class TestVulkanRenderLogits:
    """Per-kernel correctness tests for render_logits."""
