# tests/tier2/vulkan/test_vulkan_plan_rendering_correctness.py
"""Tier 2 Vulkan tests: end-to-end plan rendering correctness (full Act + Learn)."""
...
class TestVulkanPlanRenderingCorrectness:
    """End-to-end plan rendering correctness tests for Vulkan backend."""
    ...
    def test_deterministic_results(self):
        """Same inputs produce bit-exact same outputs (determinism)."""
