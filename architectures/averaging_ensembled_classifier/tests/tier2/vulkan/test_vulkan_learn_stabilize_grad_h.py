# tests/tier2/vulkan/test_vulkan_learn_stabilize_grad_h.py
"""Tier 2 Vulkan tests: stabilize_reduce_grad_h kernel (Node 16)."""
...
class TestVulkanStabilizeReduceGradH:
    """Per-kernel correctness tests for Vulkan Node 16 (ADR-005 opacity)."""
