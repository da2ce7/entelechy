# tests/tier2/vulkan/test_vulkan_learn_reduction.py
"""Tier 2 Vulkan tests: reduction tree rendering (Nodes 14/15/20)."""
...
class TestVulkanReductionTree:
    """Per-kernel correctness tests for Vulkan multi-stage reduction tree."""
    ...
    def test_reduction_correctness_parametrized(self, num_partials: int, fan_in: int):
        ...
        ref = ref_reduction_tree_sum(partials, fan_in=fan_in)
        expected = sum(partials[1:], partials[0].copy())
    ...
    def test_reduction_single_partial_passthrough(self):
        ...
        ref = ref_reduction_tree_sum([partial], fan_in=4)
