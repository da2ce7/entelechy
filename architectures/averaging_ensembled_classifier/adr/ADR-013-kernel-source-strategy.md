...
- [ADR-014: Build System Integration](ADR-014-build-system-integration-stub.md) — SPIR-V compilation targets, C shared library compilation, OpenCL kernel source path configuration
